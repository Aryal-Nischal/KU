...
public class FragmentDrawer extends Fragment {
    ...
    private static String[] newTitles=null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // drawer labels
        HandleXml xmlObj= new HandleXml(finalUrl);
        xmlObj.fetchXML();
        while (xmlObj.parsingComplete) ;
        subjects=xmlObj.getSubject();
        titles = new String[subjects.size()];
        subjects.toArray(titles);
        newTitles = titles;
